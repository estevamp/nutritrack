...
import { getRecentLogs, getDayLog, getWeightEntries, saveWeightEntry, deleteWeightEntry, getSettings } from '.././services/db';
import { type DayLog, type MealType, type NutrientGoals, type WeightEntry } from '../types';
import { Calendar, ChevronRight, Edit2, Save, Scale, Trash2, X } from 'lucide-react';
...
const HistoryPage: React.FC = () => {
  ...
  useEffect(() => {
    const loadHistory = async () => {
      ...
      const [recentLogs, weights, settings] = await Promise.all([
    ...
    <div className="page-container" style={{ padding: '16px' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
          ...
          <div>
            <h3 style={{ margin: 0, fontSize: '1.1rem' }}>Peso</h3>
            {targetWeightKg && (
        ...
        {weightEntries.length === 0 ? (
          ...
          <>
            ...
            <div style={{ width: '100%', minWidth: 0, height: 220, minHeight: 220, marginBottom: '16px' }}>
